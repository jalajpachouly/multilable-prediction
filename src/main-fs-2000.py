...
def prepare_data(X_train: pd.DataFrame, X_test: pd.DataFrame, y_train: pd.DataFrame, top_k=2000, vocabulary=None):
    """
...
def main(data_type='Unbalanced'):
    ...
    # ----------------------------
    top_k = 2000  # Number of top features to select based on Chi-Square scores
    try:
